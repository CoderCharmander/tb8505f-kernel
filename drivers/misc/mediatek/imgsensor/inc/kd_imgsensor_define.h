...
enum ACDK_SENSOR_FEATURE_ENUM {
	...
	SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO,	//67
	SENSOR_FEATURE_SET_YUV_3A_CMD,			//68
	SENSOR_FEATURE_SET_N3D_I2C_STREAM_REGDATA,	//69
	SENSOR_FEATURE_SET_N3D_STOP_STREAMING,		//70
	SENSOR_FEATURE_SET_N3D_START_STREAMING,		//71
	SENSOR_FEATURE_GET_SENSOR_N3D_STREAM_TO_VSYNC_TIME,	//72
	SENSOR_FEATURE_SET_ESHUTTER_GAIN,		//73
	SENSOR_FEATURE_SET_OB_LOCK,			//74
	SENSOR_FEATURE_SET_SENSOR_OTP_AWB_CMD,		//75
	SENSOR_FEATURE_SET_SENSOR_OTP_LSC_CMD,		//76
	SENSOR_FEATURE_GET_YUV_CAPTURE_OUTPUT_JPEG,	//77
	SENSOR_FEATURE_SET_YUV_JPEG_PARA,		//78
	SENSOR_FEATURE_GET_YUV_JPEG_INFO,		//79
	SENSOR_FEATURE_SET_FRAMERATE,			//80
	SENSOR_FEATURE_SET_HDR,				//81
	SENSOR_FEATURE_GET_CROP_INFO,			//82
	SENSOR_FEATURE_GET_VC_INFO,			//83
	SENSOR_FEATURE_SET_IHDR_SHUTTER_GAIN,		//84
	SENSOR_FEATURE_SET_AWB_GAIN,			//85
	SENSOR_FEATURE_SET_MIN_MAX_FPS,			//86
	SENSOR_FEATURE_GET_PDAF_INFO,			//87
	SENSOR_FEATURE_GET_PDAF_DATA,			//88
	SENSOR_FEATURE_SET_PDFOCUS_AREA,		//89
	SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY,	//90
	SENSOR_FEATURE_DEBUG_IMGSENSOR,			//91
	SENSOR_FEATURE_SET_HDR_SHUTTER,			//92
	SENSOR_FEATURE_SET_ISO,				//93
	SENSOR_FEATURE_SET_PDAF,			//94
	SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME,		//95
	SENSOR_FEATURE_SET_SHUTTER_BUF_MODE,		//96
	SENSOR_FEATURE_SET_GAIN_BUF_MODE,		//97
	SENSOR_FEATURE_SET_I2C_BUF_MODE_EN,		//98
	SENSOR_FEATURE_GET_SENSOR_HDR_CAPACITY,		//99
	SENSOR_FEATURE_GET_PDAF_TYPE,			//100
	SENSOR_FEATURE_SET_PDAF_TYPE,			//101
	SENSOR_FEATURE_GET_PDAF_REG_SETTING,		//102
	SENSOR_FEATURE_SET_PDAF_REG_SETTING,		//103
	SENSOR_FEATURE_SET_STREAMING_SUSPEND,		//104
	SENSOR_FEATURE_SET_STREAMING_RESUME,		//105
	SENSOR_FEATURE_OPEN,				//106
	SENSOR_FEATURE_CLOSE,				//107
	SENSOR_FEATURE_SET_DRIVER,			//108
	SENSOR_FEATURE_CHECK_IS_ALIVE,			//109
	SENSOR_FEATURE_GET_4CELL_DATA,			//110
	SENSOR_FEATURE_SET_WAKE_LOCK,			//111
	SENSOR_FEATURE_GET_MIPI_PIXEL_RATE,		//112
	SENSOR_FEATURE_SET_HDR_ATR,			//113
	SENSOR_FEATURE_SET_HDR_TRI_GAIN,		//114
	SENSOR_FEATURE_SET_HDR_TRI_SHUTTER,		//115
	SENSOR_FEATURE_SET_LSC_TBL,			//116
	SENSOR_FEATURE_GET_SENSOR_SYNC_MODE_CAPACITY,	//117
	SENSOR_FEATURE_GET_SENSOR_SYNC_MODE,		//118
	SENSOR_FEATURE_SET_SENSOR_SYNC_MODE,		//119
	SENSOR_FEATURE_GET_PIXEL_RATE,			//120
	SENSOR_FEATURE_OPEN_SECURE_SESSION,		//121
	SENSOR_FEATURE_CLOSE_SECURE_SESSION,		//122
	SENSOR_FEATURE_SET_AS_SECURE_DRIVER,		//123
	SENSOR_FEATURE_GET_AE_EFFECTIVE_FRAME_FOR_LE,	//124
	SENSOR_FEATURE_GET_AE_FRAME_MODE_FOR_LE,	//125
	SENSOR_FEATURE_GET_CTRL_PIN_CAPABILITY,		//126
	SENOSR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE,	//127
	SENSOR_FEATURE_MAX				//128
};
