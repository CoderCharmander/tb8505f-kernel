...
#include "hi556frontmipiraw_Sensor.h"

#define PFX "hi556front_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI556FRONT_SENSOR_ID,
...
static kal_uint16 hi556front_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi556front[] = {
	0x0a00, 0x0000,
	0x0e00, 0x0102,
	0x0e02, 0x0102,
	0x0e0c, 0x0100,
...
{
#if MULTI_WRITE
	hi556front_table_write_cmos_sensor(
		addr_data_pair_init_hi556front,
		sizeof(addr_data_pair_init_hi556front) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi556front[] = {
	0x0b0a, 0x8259,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
#if MULTI_WRITE
	hi556front_table_write_cmos_sensor(
		addr_data_pair_preview_hi556front,
		sizeof(addr_data_pair_preview_hi556front) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi556front[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
kal_uint16 addr_data_pair_capture_30fps_hi556front[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7067,
	0x004a, 0x0100,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi556front_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi556front,
		sizeof(addr_data_pair_capture_30fps_hi556front) /
		sizeof(kal_uint16));
	} else {
	hi556front_table_write_cmos_sensor(
		addr_data_pair_capture_fps_hi556front,
		sizeof(addr_data_pair_capture_fps_hi556front) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi556front[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7267,
	0x004a, 0x0100,
...
#if MULTI_WRITE
	hi556front_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi556front,
		sizeof(addr_data_pair_hs_video_hi556front) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0b0a, 0x8252);
	write_cmos_sensor(0x0f30, 0x6e25);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi556front[] = {
	0x0b0a, 0x8252,
	0x0f30, 0x6e25,
	0x0f32, 0x7167,
	0x004a, 0x0100,
...
#if MULTI_WRITE
	hi556front_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi556front,
		sizeof(addr_data_pair_slim_video_hi556front) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0b0a, 0x8252);
	write_cmos_sensor(0x0f30, 0x6e25);
...
UINT32 HI556FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
