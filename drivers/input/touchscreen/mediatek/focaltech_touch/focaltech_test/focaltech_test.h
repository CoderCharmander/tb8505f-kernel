...
*****************************************************************************/
#define FTS_INI_FILE_PATH                       "/vendor/etc/" //+bug:446258,liutongxing.wt,add,20190521,tp openshort test.
//#define FTS_INI_FILE_PATH                       "/mnt/sdcard/"
#define FTS_CSV_FILE_NAME                       "testdata.csv"
#define FTS_TXT_FILE_NAME                       "testresult.txt"
#define FTS_SAVE_OPENSHORT_TEST_DATA_FILE_PATH  "/mnt/sdcard/" //+bug:446258,liutongxing.wt,add,20190521,tp openshort test.
#define false 0
#define true  1
