...
static struct smtc_reg_data sx9310_i2c_reg_setup[] = {
	{
		.reg = sx9310_IRQ_ENABLE_REG, //0x03
		.val = 0x70,
	},
	{
		.reg = sx9310_IRQFUNC_REG,  //0x04
		.val = 0x00,
	},
	{
		.reg = sx9310_CPS_CTRL1_REG,  //0x11
		.val = 0x00,
	},
	{
		.reg = sx9310_CPS_CTRL2_REG,  //0x12
		.val = 0x0b,
	},
	{
		.reg = sx9310_CPS_CTRL3_REG,  //0x13
		.val = 0x0A,
	},
	{
		.reg = sx9310_CPS_CTRL4_REG,  //0x14
		.val = 0x25,
	},
	{
		.reg = sx9310_CPS_CTRL5_REG,  //0x15
		.val = 0xC3,
	},
	{
		.reg = sx9310_CPS_CTRL6_REG,  //0x16
		.val = 0x20,
	},
	{
		.reg = sx9310_CPS_CTRL7_REG,  //0x17
		.val = 0x4C,
	},
	{
		.reg = sx9310_CPS_CTRL8_REG,  //0x18
		.val = 0x28,
	},
	{
		.reg = sx9310_CPS_CTRL9_REG,  //0x19
		.val = 0x38,
	},
	{
		.reg = sx9310_CPS_CTRL10_REG,  //0x1a
		.val = 0x10,
	},
	{
		.reg = sx9310_CPS_CTRL11_REG,  //0x1b
		.val = 0x00,
	},
	{
		.reg = sx9310_CPS_CTRL12_REG,  //0x1c
		.val = 0x00,
	},
	{
		.reg = sx9310_CPS_CTRL13_REG,  //0x1d
		.val = 0x00,
	},
	{
		.reg = sx9310_CPS_CTRL14_REG,  //0x1e
		.val = 0x00,
	},
	{
		.reg = sx9310_CPS_CTRL15_REG,  //0x1f
		.val = 0x00,
	},
	{
		.reg = sx9310_CPS_CTRL16_REG,  //0x20
		.val = 0x00,
	},
	{
		.reg = sx9310_CPS_CTRL17_REG,  //0x21
		.val = 0x18,
	},
	{
		.reg = sx9310_CPS_CTRL18_REG,  //0x22
		.val = 0x25,
	},
	{
		.reg = sx9310_CPS_CTRL19_REG,  //0x23
		.val = 0x00,
	},
	{
		.reg = sx9310_SAR_CTRL0_REG,  //0x2A
		.val = 0x01,
	},
/*	{
		.reg = sx9310_SAR_CTRL1_REG,  //0x2B
		.val = 0x80,
	},
	{
		.reg = sx9310_SAR_CTRL2_REG,  //0x2C
		.val = 0x0C,
	},
*/
	{
		.reg = sx9310_CPS_CTRL0_REG,  //0x10
		.val = 0x27,
	},
};
...
static struct _buttonInfo psmtcButtons[] = {
	...
	{
		.keycode = 253,    //CS1  for ltev
		.mask = sx9310_TCHCMPSTAT_TCHSTAT1_FLAG,
	},
	{
		.keycode = 254,     //CS2  for wifi
...
struct sx93XX 
{
	...
	*/
    ...
    unsigned int irq_num;//irq gpio num
	...
	* or does not work properly */
	...
	struct delayed_work dworker; /* work struct for worker function */
        ...
        //int invalid_check;
	struct delayed_work invalid_worker; /* work struct for worker function */
#endif
};
